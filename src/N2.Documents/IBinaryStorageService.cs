...
{
    /// <summary>
    /// Open a file information object based on a file identifier. This can be a path or a guid or
    /// any other string that can be used as an identifier.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// full resource identifier for the file.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// true if a file was found and could be removed.
    /// </returns>
    ...
    /// </param>
    /// <param name="uuid">
    /// A unique identifier that will be used as part or the path.
    /// </param>
    /// <returns>
    /// A valid safe path or an empty string if a path could not be created.
    /// </returns>
